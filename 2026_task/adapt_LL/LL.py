...
# -*- coding: utf-8 -*-
"""
2026 魔方绕桩 — LL 参考流程（蓝 L7=0.6m，红 L6=0.6m）

自包含脚本：内嵌 cube_v4 同款函数库 + 本布局比赛流程。
不 import 根目录 cube_v4.py。规则见 2026_version_example.md 与 rule.png。
"""
...
if __name__ == "__main__":
    # LL 布局参考流程；角度、stop_pixels、duration 须按现场微调
    ...
    try:
        ...
        turn_angle(80)
        time.sleep(0.3)
        forward_pid(40,40,0.5,0.05,0.3)
        time.sleep(0.3)
